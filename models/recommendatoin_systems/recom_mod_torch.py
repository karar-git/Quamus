...
def recommend(user_query, top = 5,top_k=40, beta = 0.33):
    ...
    def simi(query_embedding, course_embedding):
        ...
        return util.cos_sim(query_embedding, course_embedding)[0] * 1 #+ (1-beta) *( util.euclidean_sim(query_embedding,course_embedding)[0])
    ...
    if nu_of_interaction >5:
        ...
        hybrid_scores = 0.8 * query_sim[top40] + 0.2 * personality_sim
